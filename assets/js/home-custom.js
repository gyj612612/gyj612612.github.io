...
var translations = [
  ...
  ["#description", "AI-focused researcher working across agent systems, machine perception, UAV systems, path planning, embedded systems, intelligent hardware, and self-evolving agents.", "聚焦智能体系统、自进化智能体、机器感知与路径规划，同时开展 UAV 系统、嵌入式系统及智能硬件实践。"],
  ...
  ["#highlights h2", "A quick visual map of agent systems, UAV systems, robotics, self-evolving agents, and entrepreneurship.", "以智能体、UAV 系统、机器人、自进化智能体与技术创业为主线的能力图谱。"],
  ...
  [".ai-stack-list span:nth-child(2)", "UAV systems", "UAV 系统"],
  ...
  [".ai-stack-list span:nth-child(7)", "Self-evolving agents", "自进化智能体"],
  [".image-showcase figcaption", "AI-centered research map: trustworthy agent memory, UAV systems, multimodal perception, robotics, and product validation.", "以 AI 为中心的研究图谱：可信智能体记忆、UAV 系统、多模态感知、机器人执行与产品验证。"],
  ...
  ["#cv-snapshot article:nth-child(2) p", "Trustworthy memory for LLM agents, UAV systems, LMBSWO path planning, robot visual inspection, multimodal fusion, embedded robotics, and self-evolving agent research.", "覆盖大模型智能体可信记忆、UAV 系统、LMBSWO 路径规划、机器人视觉巡检、多模态融合、嵌入式机器人与自进化智能体研究。"],
  ...
  ["#research h2", "Agent memory, UAV systems, perception, embodied AI, and self-evolving agents.", "可信智能体记忆、UAV 系统、感知、具身智能与自进化智能体。"],
  ...
  ["#research .card-grid article:nth-child(2) h3", "UAV systems", "UAV 系统"],
  ["#research .card-grid article:nth-child(2) p", "Ongoing work on aerial autonomy, perception, planning, flight control, and system-level validation.", "围绕 UAV 自主飞行、环境感知、路径规划、飞行控制与系统级验证开展研究。"],
  ...
  ["#research .card-grid article:nth-child(3) a", "Read publication signal", "查看论文信息"],
  ["#research .card-grid article:nth-child(4) h3", "AI visual inspection and semantic mapping", "AI 视觉巡检与语义建图"],
  ["#research .card-grid article:nth-child(4) p", "Robot visual perception system for dynamic inspection scenes, combining lightweight detection, semantic mapping, and adaptive resolution control.", "面向动态巡检场景的机器人视觉感知系统，结合轻量检测、语义建图与自适应分辨率控制。"],
  ["#research .card-grid article:nth-child(4) a", "View project timeline", "查看项目时间线"],
  ["#research .card-grid article:nth-child(5) h3", "Machine learning for engineering structures", "工程结构机器学习"],
  ["#research .card-grid article:nth-child(5) p", "Cross-domain work applying factor analysis, multiple ML models, and Bayesian optimization to composite structural performance prediction.", "跨学科研究，将因子分析、多种机器学习模型与贝叶斯优化用于复合结构性能预测。"],
  ["#research .card-grid article:nth-child(5) a", "Open academic profiles", "打开学术主页"],
  ["#research .card-grid article:nth-child(6) h3", "ASC-CogFusion multimodal feature fusion", "ASC-CogFusion 多模态特征融合"],
  ["#research .card-grid article:nth-child(6) p", "Heuristic-algorithm-based multisensor multimodal feature fusion work, connecting sensor reasoning, cognition-inspired fusion, and robust robot perception.", "基于启发式算法的多传感器多模态融合工作，连接传感器推理、认知式融合与稳健机器人感知。"],
  ["#research .card-grid article:nth-child(6) a", "See resume cards", "查看简历卡片"],
  ["#research .card-grid article:nth-child(7) h3", "Fruit-picking robot with embedded AI", "嵌入式 AI 采摘机器人"],
  ["#research .card-grid article:nth-child(7) p", "RAICOM champion project combining STM32F411 lower-computer control, Jetson Nano image recognition, robotic arm coordination, and autonomous path following.", "RAICOM 冠军项目，结合 STM32F411 下位机控制、Jetson Nano 图像识别、机械臂协同与自主循迹。"],
  ["#research .card-grid article:nth-child(7) a", "View awards", "查看竞赛荣誉"],
  ["#research .card-grid article:nth-child(8) h3", "PVDF sonar and intelligent sensing", "PVDF 声呐与智能感知"],
  ["#research .card-grid article:nth-child(8) p", "Product-facing work around PVDF membrane sonar, intelligent recognition devices, and sensor-oriented technology transfer for robotics and marine applications.", "围绕 PVDF 薄膜声呐、智能识别设备与面向机器人/海洋应用的传感技术转化。"],
  ["#research .card-grid article:nth-child(8) a", "View venture work", "查看创业实践"],
  ["#research .card-grid article:nth-child(9) .research-status", "Ongoing research", "在研课题"],
  ["#research .card-grid article:nth-child(9) h3", "Self-evolving agents", "自进化智能体"],
  ["#research .card-grid article:nth-child(9) p", "Ongoing research on adaptive intelligent-agent systems. Technical details are withheld while the direction remains under active development.", "开展自适应智能体系统方向研究；课题处于推进阶段，暂不公开具体技术细节。"],
  ["#research .card-grid article:nth-child(9) a", "View current direction", "查看在研方向"],
  ...
  ["#ventures article:nth-child(1) h3", "Deep-sea robotics and PVDF sonar · Nanjing Zhongke Zhilian", "深海机器人与 PVDF 声呐 · 南京中科智联"],
  ["#ventures article:nth-child(1) p", "Founder work around deep-sea explorer robots and PVDF membrane sonar, including product experiments, signed orders, institutional cooperation, and intellectual property.", "作为南京中科智联创始人，围绕深海探测机器人和 PVDF 薄膜声呐推进产品实验、订单签约、机构合作与知识产权工作。"],
  ...
  ["#experience article:nth-child(1) h3", "Automation instrumentation intern · Yancheng Kaiyuan Automation", "自动化仪表实习 · 盐城开源自动化"],
  ...
  ["#experience article:nth-child(2) h3", "PLC control engineering intern · Jiangsu Hongli Intelligent Equipment", "PLC 控制工程实习 · 江苏宏力智能装备"],
  ...
  ["#experience article:nth-child(3) h3", "Market research intern · Nanjing Jinmili", "市场研究实习 · 南京金米粒"],
  ...
  ["#resume .resume-slide:nth-of-type(2) p", "Trustworthy memory for LLM agents, UAV systems, LMBSWO path planning, multimodal fusion, robot inspection perception, embedded robotics, and self-evolving agent research.", "包括大模型智能体可信记忆、UAV 系统、LMBSWO 路径规划、多模态融合、机器人巡检感知、嵌入式机器人与自进化智能体研究。"],
  ...
  ["#resume .resume-slide:nth-of-type(4) p", "Internships at Yancheng Kaiyuan Automation, Jiangsu Hongli Intelligent Equipment, and Nanjing Jinmili across industrial automation, PLC control, and market research.", "曾在盐城开源自动化、江苏宏力智能装备与南京金米粒实习，覆盖工业自动化、PLC 控制与市场研究。"],
...
function applyLanguage(language) {
  ...
  var agentMap = document.querySelector("[data-agent-map]");
  if (agentMap) {
    agentMap.src = language === "zh" ? "assets/img/ai-agent-map-zh.svg" : "assets/img/ai-agent-map.svg";
    agentMap.alt = language === "zh"
      ? "展示可信智能体记忆、UAV 系统、多模态感知、机器人执行与产品验证的 AI 研究图谱。"
      : "AI research map covering trustworthy agent memory, UAV systems, multimodal perception, robotics, and product validation.";
  }
